...
insert into student(id,name,age,address) values(1,'汪云飞',32,'合肥');
insert into student(id,name,age,address) values(2,'xx',31,'北京');
insert into student(id,name,age,address) values(3,'yy',30,'上海');
insert into student(id,name,age,address) values(4,'zz',29,'南京');
insert into student(id,name,age,address) values(5,'aa',28,'武汉');
insert into student(id,name,age,address) values(6,'bb',27,'合肥');
insert into student(id,name,age,address) values(7,'bb',27,'合肥');
insert into student(id,name,age,address) values(8,'bb',27,'合肥');